...
$biaya_termohon = 4 * $result2["biaya"];
...
<head>
    ...
    <title>Rincian Cerai Talak</title>
    <style>
    .isi{
...
<tr class="isi">
      <td colspan="2" class="isi" style="padding: 10px 0; text-align: center">
          <h4>Rincian Biaya Perkara Cerai Talak</h4>
      </td> 
</tr>
  <tr class="isi">
