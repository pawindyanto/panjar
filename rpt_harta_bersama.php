...
$nama_dokumen = 'Rincian Biaya Panjar Harta Bersama'; //Beri nama file PDF hasil.
...
<head>
    ...
    <title>Rincian Harta Bersama</title>
    <style>
    .isi{
...
<tr class="isi">
      <td colspan="2" class="isi" style="padding: 10px 0; text-align: center">
          <h4>Rincian Biaya Perkara Gugatan Harta Bersama</h4>
      </td> 
</tr>
  <tr class="isi">
