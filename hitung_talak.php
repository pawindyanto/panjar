          ...
          <form action="" method="POST">
            <div class="card mb-3 z-index-2 h-100">
              <div class="card-header pb-0 pt-3 bg-transparent">
                <h6 class="text-capitalize">Cerai Talak (Yang Diajukan Oleh Suami)</h6>

              </div>
              <div class="card-body">
                <div class="card">
                  <div class="card-header pb-0 bg-transparent">
                    <h6 class="text-capitalize">Data Pemohon (Suami)</h6>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="kota1" id="kota1" required>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="kecamatan1" id="kecamatan1" required>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="kelurahan1" id="kelurahan1" required>
                ...
                <div class="card mt-2">
                  <div class="card-header pb-0  bg-transparent">
                    <h6 class="text-capitalize">Data Termohon (Istri)</h6>
                  </div>
                  <div class="card-body">
