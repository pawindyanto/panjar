  ...
  <script type="text/javascript">
    responsiveVoice.OnVoiceReady = function() {
      ...
      responsiveVoice.speak(
        "Jumlah Biaya Hak Asuh Anak Sebesar <?php echo $terbilang; ?> Rupiah",
        "Indonesian Female", {
          pitch: 1,
          rate: 1,
          volume: 1
        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
          <div class="card mb-3 z-index-2 h-100">
            <div class="card-header pb-0 text-center pt-3 bg-transparent">
              <h6 class="text-capitalize">Rincian Biaya Panjar Hak Asuh Anak</h6>
            ...
            <div class="card-body">
              ...
              <div class="mt-4">
                <a href="hitung_hak_asuh" class="btn btn-sm btn-danger" style="margin-right: 15px;">Close</a>
                <a href="rpt_hak_asuh" class="btn btn-sm btn-primary">Print PDF</a>
              </div>
            </div>
