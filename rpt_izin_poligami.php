...
$nama_dokumen = 'Rincian Biaya Panjar Izin Poligami'; //Beri nama file PDF hasil.
...
<head>
    ...
    <title>Rincian Izin Poligami</title>
    <style>
    .isi{
...
<tr class="isi">
  ...
  <tr class="isi">
      <td style=" width:25%; padding-left: 10px; padding-top: 10px; text-align: left">
          <p>Panggilan Pemohon 1 & pemohon 2 (2 Kali)</p>
          <br>
  ...
  <tr class="isi">
      <td style=" width:25%; padding-left: 10px; padding-top: 10px; text-align: left">
          <p>Panggilan Pemohon 3 (3 Kali)</p>
          <br>
