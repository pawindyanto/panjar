                  ...
                  if ($jumlah == '1') {
                    ...
                    echo '<script type="text/javascript">
                                      responsiveVoice.OnVoiceReady = function() {
                                        ...
                                        responsiveVoice.speak(
                                          "    Jumlah Biaya Dispensasi Kawin dengan satu pemohon Sebesar  ' . $terbilang . 'Rupiah",
                                          "Indonesian Female", {
                                            pitch: 1,
                                            rate: 1,
                                            volume: 1
                    ...
                    echo '<script type="text/javascript">
                                      responsiveVoice.OnVoiceReady = function() {
                                        console.log("speech time?");
                                        responsiveVoice.speak(
                                          "    Jumlah Biaya Dispensasi Kawin dengan dua pemohon  Sebesar  ' . $terbilang . 'Rupiah",
                                          "Indonesian Female", {
                                            pitch: 1,
                                            rate: 1,
                                            volume: 1
                    ...
                    $redaksi = 10000;
                    $materai = 10000;
                    $jumlah = $biaya_pemohon + $biaya_pemohon2 + $biaya_pemohon3 + $pendaftaran + $proses + ($pnbp_pgl1 * 3) + $pnbp_putusan + $redaksi + $materai;
                    ...
                    echo '<script type="text/javascript">
                                      responsiveVoice.OnVoiceReady = function() {
                                        console.log("speech time?");
                                        responsiveVoice.speak(
                                          "    Jumlah Biaya Dispensasi Kawin dengan tiga pemohon  Sebesar  ' . $terbilang . 'Rupiah",
                                          "Indonesian Female", {
                                            pitch: 1,
                                            rate: 1,
                                            volume: 1
                    ...
                    $redaksi = 10000;
                    $materai = 10000;
                    $jumlah = $biaya_pemohon + $biaya_pemohon2 + $biaya_pemohon3 + $biaya_pemohon4 + $pendaftaran + $proses + ($pnbp_pgl1 * 4)  + $pnbp_putusan + $redaksi + $materai;
                    ...
                    echo '<script type="text/javascript">
                                      responsiveVoice.OnVoiceReady = function() {
                                        console.log("speech time?");
                                        responsiveVoice.speak(
                                          "    Jumlah Biaya Dispensasi Kawin dengan empat pemohon  Sebesar  ' . $terbilang . 'Rupiah",
                                          "Indonesian Female", {
                                            pitch: 1,
                                            rate: 1,
                                            volume: 1
